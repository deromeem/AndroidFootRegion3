...
public class MesClubsActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes_clubs);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent in = new Intent(getApplicationContext(), ClubActivity.class);
    ...
    class LoadItems extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            // super.onPreExecute();
            pDialog = new ProgressDialog(MesClubsActivity.this);
            ...
            if (success == 1) {
                ...
                try {
                    ...
                    for (int i = 0; i < items.length(); i++) {
                        ...
                        String adr_rue = obj.getString(TAG_ADR_RUE);
                        String sigle = obj.getString(TAG_SIGLE);
                        String adr_ville = obj.getString(TAG_ADR_VILLE);
                        String adr_cp = obj.getString(TAG_ADR_CP);
                        ...
                        map.put(TAG_ID, id);
                        map.put(TAG_NOM, nom);
                        map.put(TAG_ADR_RUE, adr_rue);
                        map.put(TAG_SIGLE, sigle);
                        map.put(TAG_ADR_VILLE, adr_ville);
                        map.put(TAG_ADR_CP, adr_cp);
